...
rep('P3','G3 chalk on DRIVE tap',
 ...
 'TitanFallbackFX.prototype.pulsePhase=function(){var track=refs.phaseTrack,drive=!track||!(track.classList.contains("iso")||track.classList.contains("eccentric"));if(drive&&!reduced())this.spawn(.5,"chalk");this.request(reduced()?80:720);};\n'
