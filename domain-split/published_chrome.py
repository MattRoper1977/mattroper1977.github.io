...
HUB_LINKS = [('/Lessons/', 'Lessons'), ('/resources/', 'Resources'), ('/Matt-s-Apps-/', 'Apps & tools'), ('/tools/', 'Teacher tools')]
...
def header(route, audiences, adult=False, pupil=False, theme=False, primary=False, search=SEARCH_FALLBACK):
    ...
    # Every owned Education surface gets the complete public catalogue row;
    # adult/pupil account controls above stay intact.
